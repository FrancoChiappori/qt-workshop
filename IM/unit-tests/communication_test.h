...
private slots:
    ...
    void handle_send_join_event_broadcasts_the_message_over_udp();
    void handle_call_out_event_broadcasts_the_message_over_udp();
    ...
    void receiving_join_event_on_udp_emits_proper_signal();
    void receiving_call_out_event_on_udp_emits_proper_signal();
};
